...
/**
 * Community Hub client component — receives server-fetched data as props.
 * No client-side fetches on mount = instant render.
 */
import Link from "next/link";
import {
  MessageSquare, Users, ClipboardCheck, Activity,
  ArrowRight, TrendingUp, Clock, Flame, Lock, ShoppingCart
} from "lucide-react";
