  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 pointer-events-none">
      <motion.div
        ...
        className="flex items-center bg-background/80 backdrop-blur-2xl border border-border/50 shadow-[0_8px_32px_rgba(0,0,0,0.28)] rounded-2xl p-1.5 gap-1 pointer-events-auto"
      >
        {TABS.map((tab) => {
            ...
            >
              {isActive && (
                <motion.div
                  ...
                  className="absolute inset-0 rounded-xl bg-gradient-to-r from-orange-500 to-orange-600 shadow-lg shadow-orange-500/40"
