      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
        ...
        {(isEnrolled || userRole === "ADMIN" || userRole === "INSTRUCTOR") && (
          <button
            ...
            className="flex items-center gap-2 text-muted-foreground/70 hover:text-muted-foreground text-[11px] font-medium px-3 py-1.5 rounded-lg border border-white/[0.06] hover:border-border hover:bg-white/[0.03] transition-all"
          >
