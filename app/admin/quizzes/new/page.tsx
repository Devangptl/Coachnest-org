...
import { ArrowLeft, PlusCircle, Trash2, GripVertical, Check } from "lucide-react";
...
export default function NewQuizPage() {
  ...
  const updateOption = (qIdx: number, oIdx: number, field: string, value: any) => {
    ...
    if (field === "correct" && value === true) {
      // Uncheck other options (single correct answer)
            ...
            <GlassCard key={qIdx} padding="md">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  <p className="text-white/40 text-xs font-semibold uppercase">Options</p>
