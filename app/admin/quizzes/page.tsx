    ...
    <div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 mb-10">
        {[
          ...
          { label: "Total Attempts", value: totalAttempts, icon: Users, color: "text-violet-400" },
      ...
      {Object.entries(grouped).length > 0 ? (
          ...
          {Object.entries(grouped).map(([courseId, group]) => (
            <GlassCard key={courseId} padding="sm">
              <div className="px-4 py-3 border-b border-white/10">
                ...
                <span className="text-white/40 text-xs">{group.quizzes.length} quiz(zes)</span>
              </div>
        ...
        <GlassCard padding="md">
          <div className="text-center py-12 text-white/40">
            ...
            <Link href="/admin/quizzes/new" className="text-purple-400 hover:text-purple-300">
