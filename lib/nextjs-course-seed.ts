/**
 * Next.js 16 course seed data.
 *
 * Self-contained definition of the "Next.js 16: The Complete Developer Guide"
 * course — chapters (sections), lessons with rich markdown content, and
 * end-of-chapter quizzes. Consumed by:
 *   - POST /api/admin/courses/seed-nextjs (admin button)
 *   - prisma/seed-nextjs-course.ts        (CLI: npm run db:seed:nextjs)
 *
 * Shape mirrors lib/prompt-engineering-course-seed.ts for consistency.
 */
...
export interface NextjsCourseSeed {
  course: {
    title: string;
    slug: string;
    description: string;
...
const COURSE_META = {
  ...
  slug: "nextjs-16-complete-developer-guide",
  description:
...
export function getNextjsCourseSeed(): NextjsCourseSeed {
  return {
    course: COURSE_META,
