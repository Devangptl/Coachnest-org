 ...
 * "Seed Next.js 16 Course" button by reusing lib/nextjs-course-seed.ts.
 *
...
async function main() {
  ...
  if (!instructor) {
    throw new Error(
      `Instructor ${INSTRUCTOR_ID} not found. Create the user first or set NEXTJS_SEED_INSTRUCTOR_ID.`,
    );
  }
